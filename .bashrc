                                                    ...
                                                    if [ "$(pidof claws-mail)" ];then
                                                            MAIL=`claws-mail --status | awk '{print $2}'`
                                                                    ...
                                                                    if [ "$color_prompt" = yes ]; then
                                                                            echo -en "\e[1;37m$DATE\e[m mem:\e[0;32m$MEMU\e[m/\e[0;32m$MEMT\e[m load:\e[0;34m$LOAD,\e[m up:\e[1;33m$UPT\e[m /:\e[0;31m$ROOT\e[m mail:\e[1;37m$MAIL\e[m\n"
                                                                                PS1='${debian_chroot:+($debian_chroot)}┌ \e[01;32m\u@\h\e[m - \e[01;34m[ \w ] \e[m $TIME \n└ $ '
                                                                                else
